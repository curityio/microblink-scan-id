...
function selectCamera(cameraId, preferredCameraType) {
    return __awaiter(this, void 0, void 0, function* () {
        const { frontCameras, backCameras } = yield getCameraDevices();
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia !== undefined) {
                    try {
                        ...
                        let errorCode = ErrorCodes.VIDEO_RECOGNIZER_CAMERA_IN_USE;
                        switch (error.name) {
                            case "NotFoundError":
                            case "OverconstrainedError":
                                errorReason = NotSupportedReason.CameraNotFound;
                                errorCode = ErrorCodes.VIDEO_RECOGNIZER_CAMERA_MISSING;
                                break;
                            case "NotAllowedError":
                            case "SecurityError":
                                errorReason = NotSupportedReason.CameraNotAllowed;
                                errorCode = ErrorCodes.VIDEO_RECOGNIZER_CAMERA_NOT_ALLOWED;
                                break;
                            case "AbortError":
                            case "NotReadableError":
                                errorReason = NotSupportedReason.CameraNotAvailable;
                                errorCode = ErrorCodes.VIDEO_RECOGNIZER_CAMERA_UNAVAILABLE;
                                break;
...
export { AnonymizationMode, BarcodeElementKey, BarcodeFormat, BlinkIdMultiSideRecognizerSettings, BlinkIdSingleSideRecognizerSettings, CapturedFrame, CardOrientation, Country, DetectionStatus, DocumentImageColorStatus, DocumentType, ErrorCodes, ErrorMessages, ExtensionFactors, IdBarcodeDocumentType, IdBarcodeRecognizerSettings, ImageAnalysisDetectionStatus, ImageOrientation, LicenseErrorType, LicenseTokenState, NotSupportedReason, PreferredCameraType, ProcessingStatus, RecognitionMode, RecognitionModeFilter, RecognizerResultState, Region, SDKError, SelectedCamera, ServerPermissionSubmitResultStatus, VideoRecognitionMode, VideoRecognizer, WasmSDKLoadSettings, WasmType, bindCameraToVideoFeed, captureFrame, clearVideoFeed, createBlinkIdMultiSideRecognizer, createBlinkIdSingleSideRecognizer, createIdBarcodeRecognizer, createRecognizerRunner, detectWasmType, frameCaptureErrors, getCameraDevices, isBrowserSupported, isCameraFocusProblematic, isInAppBrowser, licenseErrors, loadWasmModule, localSdkErrors, obtainNewServerPermission, sdkErrors, selectCamera, unlockWasmSDK, validateDpi, videoRecognizerErrors, wasmFolder, workerErrors };
