 ...
 */
function bindCameraToVideoFeed(camera, videoFeed, preferredCameraType = exports.PreferredCameraType.BackFacingCamera, shouldMaxResolution = false) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        const constraints = {
            audio: false,
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (!cameraFeed || !(cameraFeed instanceof Element)) {
                    reject(new SDKError(videoRecognizerErrors.elementMissing, {
                        reason: exports.NotSupportedReason.VideoElementNotProvided,
                    }));
                    return;
                }
                if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia !== undefined) {
                    try {
                        ...
                        if (selectedCamera === null) {
                            reject(new SDKError(videoRecognizerErrors.cameraMissing, {
                                reason: exports.NotSupportedReason.CameraNotFound,
                            }));
                            return;
                        }
                        ...
                        let errorCode = exports.ErrorCodes.VIDEO_RECOGNIZER_CAMERA_IN_USE;
                        switch (error.name) {
                            case "NotFoundError":
                            case "OverconstrainedError":
                                errorReason = exports.NotSupportedReason.CameraNotFound;
                                errorCode = exports.ErrorCodes.VIDEO_RECOGNIZER_CAMERA_MISSING;
                                break;
                            case "NotAllowedError":
                            case "SecurityError":
                                errorReason = exports.NotSupportedReason.CameraNotAllowed;
                                errorCode = exports.ErrorCodes.VIDEO_RECOGNIZER_CAMERA_NOT_ALLOWED;
                                break;
                            case "AbortError":
                            case "NotReadableError":
                                errorReason = exports.NotSupportedReason.CameraNotAvailable;
                                errorCode = exports.ErrorCodes.VIDEO_RECOGNIZER_CAMERA_UNAVAILABLE;
                                break;
                    ...
                    reject(new SDKError(videoRecognizerErrors.mediaDevicesUnsupported, {
                        reason: exports.NotSupportedReason.MediaDevicesNotSupported
                    }));
                }
            }));
            /* eslint-enable */
...
function wasmFolder(wasmType) {
    switch (wasmType) {
        case exports.WasmType.AdvancedWithThreads:
            return "advanced-threads";
        case exports.WasmType.Advanced:
            return "advanced";
        case exports.WasmType.Basic:
            return "basic";
    }
}
...
exports.clearVideoFeed = clearVideoFeed;
...
exports.isCameraFocusProblematic = isCameraFocusProblematic;
