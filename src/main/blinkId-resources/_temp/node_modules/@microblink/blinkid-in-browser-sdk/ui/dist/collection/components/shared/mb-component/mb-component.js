  ...
  render() {
    return (h(Host, null,
      ...
      h("mb-screen", { id: "mb-screen-action", visible: false, ref: el => this.screens.action = el },
        ...
        h("div", { class: "multi-side-image-upload" },
          h("mb-image-box", { ref: el => this.imageBoxFirst = el, "box-title": this.translationService.i('process-image-box-first').toString(), "anchor-text": this.translationService.i('process-image-box-add').toString(), onImageChange: (ev) => this.onMultiSideImageChange(ev.detail, MultiSideImageType.First) }),
          h("mb-image-box", { ref: el => this.imageBoxSecond = el, "box-title": this.translationService.i('process-image-box-second').toString(), "anchor-text": this.translationService.i('process-image-box-add').toString(), onImageChange: (ev) => this.onMultiSideImageChange(ev.detail, MultiSideImageType.Second) }),
          h("mb-button-classic", { ref: el => this.multiSideScanFromImageButton = el, disabled: true, clickHandler: () => this.startScanFromImageMultiSide() }, this.translationService.i('process-image-upload-cta').toString()))),
