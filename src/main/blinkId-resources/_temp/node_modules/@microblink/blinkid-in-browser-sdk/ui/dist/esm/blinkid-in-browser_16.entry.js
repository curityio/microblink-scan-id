 ...
 */
function bindCameraToVideoFeed(camera, videoFeed, preferredCameraType = PreferredCameraType.BackFacingCamera, shouldMaxResolution = false) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        const constraints = {
            audio: false,
        ...
        if (shouldMaxResolution) {
            ...
            void track.applyConstraints({
                width: (_a = capabilities.width) === null || _a === void 0 ? void 0 : _a.max,
                height: (_b = capabilities.height) === null || _b === void 0 ? void 0 : _b.max
            });
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia !== undefined) {
                    try {
                        ...
                        const cameraFlipped = yield bindCameraToVideoFeed(selectedCamera, cameraFeed, preferredCameraType, shouldMaxResolution);
...
function checkThreadsSupport() {
    return __awaiter(this, void 0, void 0, function* () {
        const supportsWasmThreads = yield threads();
...
function detectWasmType() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const threadsSupported = yield checkThreadsSupport();
        if (haveSIMD) {
            if (threadsSupported) {
 ...
 * @param wasmSDK Instance of WasmSDK which will be used to communicate with the WebAssembly module.
 */
function createBlinkIdSingleSideRecognizer(wasmSDK) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 * @param wasmSDK Instance of WasmSDK which will be used to communicate with the WebAssembly module.
 */
function createBlinkIdMultiSideRecognizer(wasmSDK) {
    return __awaiter(this, void 0, void 0, function* () {
...
const BlinkIDSDK = /*#__PURE__*/Object.freeze({
  ...
  isCameraFocusProblematic: isCameraFocusProblematic,
