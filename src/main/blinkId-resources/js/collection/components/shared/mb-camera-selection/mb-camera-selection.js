 ...
 */
import { Component, Element, Event, Host, h, Method, State, Prop } from '@stencil/core';
...
export class MbCameraSelection {
  ...
  render() {
    const cameraListElements = this.cameraList.map((camera) => {
      ...
      if (isActive) {
        content = (h("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
          h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M17.2559 5.24408C17.5813 5.56951 17.5813 6.09715 17.2559 6.42259L8.92257 14.7559C8.59713 15.0814 8.06949 15.0814 7.74406 14.7559L3.57739 10.5893C3.25195 10.2638 3.25195 9.73618 3.57739 9.41074C3.90283 9.08531 4.43047 9.08531 4.7559 9.41074L8.33331 12.9882L16.0774 5.24408C16.4028 4.91864 16.9305 4.91864 17.2559 5.24408Z", fill: "#0062F2" })));
      }
      return (h("li", { class: classNames({ active: isActive }) },
        h("button", { onClick: (ev) => this.handleCameraSelection(ev, camera) },
          content,
          h("span", { class: "name" }, camera.prettyName))));
    });
    return (h(Host, null,
      h("button", { class: this.isListVisible ? 'active-camera active' : 'active-camera', onClick: (ev) => this.handleListOpen(ev) },
        h("span", { class: "icon" },
