import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './index-5647af98.js';
...
let MbButtonClassic = class {
  ...
  render() {
    return (h(Host, null, h("button", { disabled: this.disabled, onClick: this.clickHandler }, h("slot", null))));
  }
  get hostEl() { return getElement(this); }
};
